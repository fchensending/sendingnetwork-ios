...
public extension String {
    ...
    var attributedFromHTML: NSMutableAttributedString {
        NSMutableAttributedString(html: self) ?? NSMutableAttributedString(string: self)
    }
}
...
public extension NSMutableAttributedString {
    ...
    */
    @discardableResult
    func addAttribute(_ key: NSAttributedString.Key, value: Any, range: NSRange? = nil) -> Self {
        if let range = range {
     ...
     */
    @discardableResult
    func addAttributes(_ attrs: [NSAttributedString.Key : Any], range: NSRange? = nil) -> Self {
        if let range = range {
    ...
    /**
     ...
     - Parameters:
        ...
        - range: Range to apply. The value `nil` means full range.
     */
    func customFont(name: String, ofSize size: CGFloat, range: NSRange? = nil) -> Self? {
        guard let font = UIFont(name: name, size: size) else {
            debugPrint("\(name) font does not exist")
            return nil
        }
    ...
    func systemFont(
        ...
        font(UIFont.systemFont(ofSize: size, weight: weight), range: range)
    }
    ...
    /**
     ...
     - Parameters:
        ...
        - range: Range to apply. The value `nil` means full range.
     */
    func foreground(color: UIColor, range: NSRange? = nil) -> Self {
    ...
    /**
     ...
     - Parameters:
        ...
        - range: Range to apply. The value `nil` means full range.
     */
    func background(color: UIColor, range: NSRange? = nil) -> Self {
    ...
    func paragraphStyle(
        ...
        return addAttribute(.paragraphStyle, value: paragraphStyle, range: range)
    }
    ...
    /**
     ...
     - Parameters:
       ...
       - range: Range to apply. The value `nil` means full range.
     */
    func underline(style: NSUnderlineStyle, color: UIColor? = nil, range: NSRange? = nil) -> Self {
        ...
        return addAttributes(attributes, range: range)
    }
    ...
    /**
     ...
     For more details, see Drawing attributed strings that are both filled and stroked.
       ...
       - range: Range to apply. The value `nil` means full range.
     */
    func stroke(width: Double, color: UIColor? = nil, range: NSRange? = nil) -> Self {
        var attributes: [NSAttributedString.Key: Any] = [
            .strokeWidth: width
        ]
    ...
    /**
     ...
     - Parameters:
       ...
       - range: Range to apply. The value `nil` means full range.
     */
    func kerning(_ value: Double, range: NSRange? = nil) -> Self {
    ...
    func shadow(
        ...
        return addAttribute(.shadow, value: shadow, range: range)
    }
    ...
    /**
     ...
     ```
     */
    func attachment(image: UIImage?, bounds: CGRect? = nil, range: NSRange? = nil) -> Self {
        ...
        return addAttribute(.attachment, value: attachment, range: range)
    }
