...
/**
 The `MXCredentials` class contains credentials to communicate with the Sendingnetwork
 Client-Server API.
 */
@interface MXCredentials : NSObject <NSCopying>

/**
 The node url (ex: "https://sending.network").
 */
@property (nonatomic, nullable) NSString *node;

/**
 The homeserver url (ex: "https://sending.network").
 */
...
/**
 The homeserver name (ex: "sending.network").
 */
