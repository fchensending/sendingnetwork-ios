...
/**
 ...
 from a Sendingnetwork home server.
...
/**
 ...
 @see http://sending.network/docs/spec/#password-based and below for the types descriptions
 */
...
/**
 The home server url (ex: "https://sending.network").
 */
 ...
 */
@property (nonatomic) NSNumber *guideState;
...
{
    MXScanQRCodeSuccess=200,
    MXScanQRCodeInvalid=203
} MXScanQRCode NS_REFINED_FOR_SWIFT;

typedef enum : NSUInteger
{
    MXAuthQRCodeSuccess=200,
    MXAuthQRCodeAuthFailed=201,
    MXAuthQRCodeInvalid=203
} MXAuthQRCode NS_REFINED_FOR_SWIFT;

@interface MXScanQRCodeResponse : MXJSONModel

/**
 Return code
 */
@property (nonatomic) MXScanQRCode code;
...
/**
 Temporal ticket for auth qrcode login
 */
@property (nonatomic) NSString *ticket;

@end

@interface MXAuthQRCodeResponse : MXJSONModel

/**
 Return code
 */
@property (nonatomic) MXAuthQRCode code;
...
/**
 Room tags defined by Sendingnetwork spec.
 */
...
/**
 The homeserver name.
 */
@property (nonatomic) NSString *sendingnetworkServerName;
...
/**
 ...
 specified by Sendingnetwork are listed here as NSUInteger enum in order to ease
...
typedef enum : NSUInteger
{
    ...
    MXPushRuleActionTypeCoalesce,   // At a Sendingnetwork client level, coalesce action should be treated as a notify action
...
/**
 These rules configure notification behaviour for messages from a specific, named Sendingnetwork user ID.
 The rule_id of Sender rules is always the Sendingnetwork user ID of the user whose messages theyt apply to.
 */
...
/**
 The sendingnetwork id of the inviter in case of pending invitation.
 */
...
/**
 The presence status of other users (Provided in case of room initial sync @see http://sending.network/docs/api/client-server/#!/-rooms/get_room_sync_data)).
 */
...
/**
 `MXRoomJoinRuleResponse` represents the enhanced join rule response as per [MSC3083](https://github.com/sending-network/sendingnetwork-doc/pull/3083)
 */
...
@interface MXRemark : MXJSONModel
@property (nonatomic, nullable) NSString *name;
@end

@interface MXRemarkListResponse : MXJSONModel
@property (nonatomic, nullable) NSDictionary <NSString *,MXRemark *> *remarkList;
@end

/// user asset
@interface MXMetrics : MXJSONModel
@property (nonatomic, nullable) NSString *nftsWorth;
@property (nonatomic, nullable) NSNumber *nftNum;
@property (nonatomic, nullable) NSNumber *collectionNum;
@end

@interface MXPortfolio: MXJSONModel
@property (nonatomic, nullable) NSString *imageUrl;
@end

@interface MXCryptoModel : MXJSONModel
@property (nonatomic, nullable) NSArray <NSString *> *images;
@property (nonatomic, nullable) NSString *name;
...
@interface MXUserAsset : MXJSONModel
@property (nonatomic, nullable) NSString *netWorth;
@property (nonatomic, nullable) NSString *tokensWorth;
@property (nonatomic, nullable) NSString *nftsWorth;
@property (nonatomic, nullable) MXMetrics *metrics;
@property (nonatomic, nullable) NSArray <MXPortfolio *> *portfolios;
@property (nonatomic, nullable) NSArray <MXCryptoModel *> *cryptos;
@end


@interface MXWalletAddress : MXJSONModel
@property (nonatomic, nullable) NSString *userId;
@property (nonatomic, nullable) NSString *walletAddress;
@property (nonatomic, nullable) NSString *blockChain;
@property (nonatomic, nullable) NSString *netWork;
@end


@interface MXNFTAsset : MXJSONModel
@property (nonatomic, nullable) NSString *name;
@property (nonatomic, nullable) NSString *address;
@property (nonatomic, nullable) NSString *url;
@property (nonatomic, nullable) NSString *contractAddress;
@property (nonatomic, nullable) NSString *tokenId;
@end

@interface MXNFTResponse : MXJSONModel
@property(nonatomic, nullable) NSNumber *total;
@property(nonatomic, nullable) NSArray <MXNFTAsset *> *assets;
@end

#pragma mark DID
@interface MXDIDListResponse : MXJSONModel
@property (nonatomic, nullable) NSArray<NSString *> *array;
@end

@interface MXDiDInfoResponse: MXJSONModel
...
@interface MXSaveDIDResponse : MXJSONModel
@property (nonatomic, nullable) NSString *message;
@end

@interface MXUpdateDIDResponse : MXJSONModel
@property (nonatomic, nullable) NSString *did;
@property (nonatomic, nullable) NSString *message;
@property (nonatomic, nullable) NSString *updated;
@end

@interface MXPreLoginResponse : MXJSONModel
@property (nonatomic, nullable) NSString *did;
@property (nonatomic, nullable) NSString *message;
@property (nonatomic, nullable) NSString *updated;
...
@property (nonatomic, nullable) NSNumber *guideState;
@end
